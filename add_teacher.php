 <?php 
$conn = new mysqli("localhost","root","","ardhas");
...
$subject = $_POST['subject'];
    $insert = $conn->prepare("INSERT INTO teachers(name,email,password,gender,qualification,dob,phno,address,subject) VALUES(?,?,?,?,?,?,?,?,?)");
    $insert->bind_param("ssssssiss",$name,$email,$password,$gender,$qualification,$dob,$phno,$address,$subject);
    if($insert->execute()){
